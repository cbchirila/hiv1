...
class History():
    ...
    def save(self):
        create_directory(self.data.output+"/history/")
        self.df.to_csv(self.data.output+"/history/"+self.data.modelName+"-acc-loss-hist.csv",index=False)
        return
    ...
    def plot(self,h):
        ...
        create_directory(self.data.output+"/history-plots/"+self.data.modelName+"/")
        self.save_fig(self.data.output+"/history-plots/"+
